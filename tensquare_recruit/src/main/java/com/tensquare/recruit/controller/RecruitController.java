...
public class RecruitController {
	...
	@RequestMapping(value = "/search/test2/{state}",method = RequestMethod.POST)
	public Result test2(@PathVariable String state){
		List<Recruit> list = recruitService.findTop12ByStateNotOrderByCreatetimeDesc(state);
		return new Result(true,StatusCode.OK,"查询成功",list);
	}
